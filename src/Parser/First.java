...
public class First {
    public final Hashtable<String, String> programa = new Hashtable<>()
    {
        {
            put("INT", "INT");
        }
    ...
    public final Hashtable<String, String> ELSE_IF = new Hashtable<>()
    {
        {
            put("IF", "IF");
        }
    ...
    public final Hashtable<String, String> operador_aritmetico = new Hashtable<>()
    {
        {
    ...
    public final Hashtable<String, String> operando = new Hashtable<>()
    {
        {
            put("ID", "ID");
            put("INTEGER","INTEGER");
    ...
    public final Hashtable<String, String> condicao = new Hashtable<>()
    {
        {
            put("SP_CHAR_OPEN_PARENTHESES", "SP_CHAR_OPEN_PARENTHESES");
            put("ID", "ID");
    ...
    public final Hashtable<String, String> expressao_condicao = new Hashtable<>()
    {
        {
            put("SP_CHAR_OPEN_PARENTHESES", "SP_CHAR_OPEN_PARENTHESES");
            put("ID", "ID");
    ...
    public final Hashtable<String, String> expressao_condicao_linha = new Hashtable<>()
    {
        {
            put("SP_CHAR_OPEN_PARENTHESES", "SP_CHAR_OPEN_PARENTHESES");
            put("ID", "ID");
    ...
    public final Hashtable<String, String> operacao_condicional = new Hashtable<>()
    {
        {
            put("SP_CHAR_OPEN_PARENTHESES", "SP_CHAR_OPEN_PARENTHESES");
            put("ID", "ID");
    ...
    public final Hashtable<String, String> operacao_condicional_linha = new Hashtable<>()
    {
        {
            put("ARI_OP_ADDITION", "ARI_OP_ADDITION");
            put("ARI_OP_ATTRIBUTION", "ARI_OP_ATTRIBUTION");
    ...
    public final Hashtable<String, String> extensor_condicao = new Hashtable<>()
    {
        {
            put("ARI_OP_ADDITION", "ARI_OP_ADDITION");
            put("ARI_OP_ATTRIBUTION", "ARI_OP_ATTRIBUTION");
